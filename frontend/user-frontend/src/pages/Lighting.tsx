...
const equipmentList = [
  ...
  },
  {
    id: 2,
    name: "Godox SL60W",
    image: "/images/equipment/godox-sl60w.jpg",
    pricePerDay: "Rs. 2,500",
  },
  {
    id: 3,
    name: "Westcott Flex LED Mat",
    image: "/images/equipment/westcott-flex-led.jpg",
      ...
      <main className="flex-grow px-6 py-10 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-10">
            Explore our lighting gear available for rent.
          </p>
